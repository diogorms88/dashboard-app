...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('🎨 Buscando dados detalhados de pintura da tabela registros:', { startDate, endDate, shift })
    ...
    console.log('🎨 Dados processados:', {
      ...
      entradasDetalhadas: result.length,
      tiposEncontrados: [...new Set(result.map(r => r.tipo))]
    })

    return NextResponse.json(result)

  } catch (error) {
    console.error('Erro na API de dados detalhados de pintura:', error)
