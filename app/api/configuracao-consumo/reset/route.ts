...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔄 Resetando configuração para valores padrão...')
    ...
    console.log('✅ Configuração resetada com sucesso:', data.id)
    ...
    console.error('Erro na API reset configuracao-consumo:', error)
    return NextResponse.json(
