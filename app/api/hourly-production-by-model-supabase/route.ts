...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('📊 Buscando dados de produção por hora da tabela registros:', { startDate, endDate, shift })
    ...
    console.log('📊 Dados processados:', {
      ...
      modelos: finalData.length,
      horasEncontradas: Array.from(horasComDados).sort((a, b) => a - b)
    })
    ...
    console.error('Erro na API de produção por hora:', error)
    return NextResponse.json(
